...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__SystemUse__copyl__2B0A656D] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[SystemUser] ADD CONSTRAINT [PK__SystemUs__E4276C1F061EE9E1] PRIMARY KEY CLUSTERED  ([systemuserid])
GO
