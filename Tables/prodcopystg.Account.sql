...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Account__copyloa__1CBC4616] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Account] ADD CONSTRAINT [PK__Account__F20699F6C2369A8D] PRIMARY KEY CLUSTERED  ([accountid])
GO
