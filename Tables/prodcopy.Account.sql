...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Account__copyloa__19DFD96B] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopy].[Account] ADD CONSTRAINT [PK__Account__F20699F6C325AEA9] PRIMARY KEY CLUSTERED  ([accountid])
GO
