...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Contact__copyloa__1F98B2C1] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Contact] ADD CONSTRAINT [PK__Contact__7126F91DFD48DFA8] PRIMARY KEY CLUSTERED  ([contactid])
GO
